...
class PPSwerveControllerCommand
    : public frc2::CommandHelper<frc2::CommandBase, PPSwerveControllerCommand<NumModules>> {
 ...
 public:
  ...
  PPSwerveControllerCommand(
      pathplanner::PathPlannerTrajectory, std::function<frc::Pose2d()> pose,
